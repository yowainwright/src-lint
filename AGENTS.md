...
This repository provides src-lint, a C11 CLI for checking import boundaries across languages. Follow established C11, POSIX, and CMake APIs. Custom code needs evidence and source links.
